...
public class GpsPositionManager : MonoBehaviour
{
    public Text gpsOut;
    ...
    IEnumerator GetLocation()
    {
        ...
        {
            gpsOut.text = "Location: " + Input.location.lastData.latitude + " " + Input.location.lastData.longitude + " " + Input.location.lastData.altitude + 100f + " " +
